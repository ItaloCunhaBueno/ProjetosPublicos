...
parser.add_argument('--output_dir', type=str, default=OUTDIR, help='Directory where to output high res images.')
...
def main():
    ...
    model = keras.models.load_model(r'E:\Trabalho\Repos\ProjetosPublicos\Fast-SRGAN\models\generator.h5', compile=False)
