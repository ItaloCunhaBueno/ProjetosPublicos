...
Layout = [[sg.T("Procurar:"), sg.I(key='keywords'), sg.B("PROCURAR", key='PROCURAR')],
          [sg.T("Resultados:"), sg.Stretch()],
          [sg.Table(Values, headings=headings, key='tabela', auto_size_columns=True)]]
...
while True:
    ...
    if event == 'PROCURAR':
        ...
        for torrent in torrents[1:]:
            ...
            TEXTO = [nome, seeders, leechers, date, size, user, link]
